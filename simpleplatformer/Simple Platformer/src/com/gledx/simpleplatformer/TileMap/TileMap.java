...
public class TileMap {
	...
	public TileMap(int tileSize) {
		...
		numRowsToDraw = Main.windowHeight / tileSize + 2;
		numColsToDraw = Main.windowWidth / tileSize + 2;
		tween = 0.07;
	}
	...
	public void loadMap(String s) {
		...
		try {
			...
			xmin = Main.windowWidth - width;
			xmax = 0;
			ymin = Main.windowHeight - height;
			ymax = 0;
	...
	public void setBounds(int i1, int i2, int i3, int i4) {
		xmin = Main.windowWidth - i1;
		ymin = Main.windowWidth - i2;
		xmax = i3;
		ymax = i4;
	}
